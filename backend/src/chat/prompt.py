...
'confidence level' will be a float between 0.0 and 1.0, with 1.0 being most confident in your answer.
'description' will contain a short description of the NFT, and reasoning for estimation
"""
